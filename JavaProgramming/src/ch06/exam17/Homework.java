	...
	public static void main(String[] args) {
		...
		while ( true ) {
			...
			if ( choice.equals("1") ) {
				...
				for ( Board bd : board ) {
					if ( bd != null )
						System.out.println(bd.getNo() + "\t" + bd.getTitle() + "\t" + bd.getWriter() + "\t   " + bd.getHit());
				}
				...
				for ( int i = 0 ; i < board.length ; i++ ) {
					if( board[i] == null ) {
						...
						// Board a = new Board(i, title, writer, 0, content);
						// board[i] = a; 
						// 이렇게 해도 됨
						break;
					}
