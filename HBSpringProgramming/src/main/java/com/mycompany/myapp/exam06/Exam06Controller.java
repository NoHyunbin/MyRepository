...
*/		
	...
	public String method4CreateCookie(HttpServletResponse response) throws IOException {
		// 쿠키 생성
	...
	public String methodReceiveCookieHow1(HttpServletRequest request) throws IOException {
	...
	public String methodReceiveCookieHow2(@CookieValue(defaultValue="") String mid, @CookieValue(defaultValue="") String mname) throws IOException {
