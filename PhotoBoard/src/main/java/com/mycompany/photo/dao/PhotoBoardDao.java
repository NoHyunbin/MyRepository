package com.mycompany.photo.dao;
...
public class PhotoBoardDao {
	...
	public List<PhotoBoard> selectByPageWithFind(int pageNo, int rowsPerPage, String find) {
		String sql = "";
		sql += "select rn, bno, btitle, bhitcount, bdate, savedfile ";
		sql += "from ( ";
		sql += "select rownum as rn, bno, btitle, bhitcount, bdate, savedfile ";
		sql += "from (select bno, btitle, bhitcount, bdate, savedfile from photoboard order by bno desc) ";
		sql += "where btitle like ? and rownum<=? ";
		sql += ") ";
		sql += "where rn>=? ";
	...
	public int count(String find) {
		String sql = "select count(*) from photoboard where btitle like ?";
