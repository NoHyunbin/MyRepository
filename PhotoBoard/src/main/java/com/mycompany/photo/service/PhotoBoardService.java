package com.mycompany.photo.service;
...
import com.mycompany.photo.dao.PhotoBoardDao;
...
public class PhotoBoardService {
	...
	public List<PhotoBoard> findList(int pageNo, int rowsPerPage, String find) {
		return photoBoardDao.selectByPageWithFind(pageNo, rowsPerPage, find);
	}
	...
	public int getCount(String find) {
		return photoBoardDao.count(find);
	}
